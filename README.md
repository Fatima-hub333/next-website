...
[Download the ZIP from this location](https://github.com/Fatima-hub333/next-website/archive/refs/heads/main.zip), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:

```bash
git clone https://github.com/Fatima-hub333/next-website.git
```
...
Feel free to check the [issues page](https://github.com/Fatima-hub333/next-website/issues).
